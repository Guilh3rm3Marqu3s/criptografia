...
from screens import CesarFrame, RC4Frame, Salsa20Frame, ChaCha20Frame
class MenuScreen(ctk.CTkFrame):
    ...
    def _selecionar_criptografia(self, classe_cripto):
        ...
        elif classe_cripto.NOME == "ChaCha20": self.tela_cripto_ativa = ChaCha20Frame(self.master, classe_cripto, self._voltar_ao_menu)
